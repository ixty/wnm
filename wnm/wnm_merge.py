...
def country_stats(nets, pdb, scdb, world):
    ...
    for cc in countries:
        ...
        countries[cc]['cables']         = []
        countries[cc]['lnd']            = float(world[cc]['Area(in sq km)'])    if (cc != '??' and cc != 'EU') else 0
        countries[cc]['pop']            = float(world[cc]['Population'])        if (cc != '??' and cc != 'EU') else 0
        countries[cc]['info']           = world[cc]                             if (cc != '??' and cc != 'EU') else {}
